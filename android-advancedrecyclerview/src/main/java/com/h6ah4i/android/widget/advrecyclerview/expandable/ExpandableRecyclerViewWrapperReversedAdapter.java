...
class ExpandableRecyclerViewWrapperReversedAdapter
        extends ExpandableRecyclerViewWrapperAdapter {
    ...
    public ExpandableRecyclerViewWrapperReversedAdapter(RecyclerViewExpandableItemManager manager, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter, long[] expandedItemsSavedState) {
        super(manager, adapter, expandedItemsSavedState);
