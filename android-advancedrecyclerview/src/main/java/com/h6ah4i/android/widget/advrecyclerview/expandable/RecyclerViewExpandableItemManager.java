...
public class RecyclerViewExpandableItemManager implements ExpandableItemConstants {
    ...
    @SuppressWarnings("unchecked")
    @NonNull
    public RecyclerView.Adapter createWrappedReversedAdapter(@NonNull RecyclerView.Adapter adapter) {
        if (!adapter.hasStableIds()) {
            throw new IllegalArgumentException("The passed adapter does not support stable IDs");
        }
        ...
        mWrapperAdapter = new ExpandableRecyclerViewWrapperReversedAdapter(this, adapter, adapterSavedState);
