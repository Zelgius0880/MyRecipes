 ...
 */
public class ReversedGroupAdapter<VH extends ViewHolder> extends RecyclerView.Adapter<VH> implements GroupDataObserver {
     ...
     * ReversedGroupAdapter#getItemViewType(int)} is called immediately before {@link
     * ReversedGroupAdapter#onCreateViewHolder(ViewGroup, int)}. We cache the last model
