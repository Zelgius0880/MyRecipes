...
import zelgius.com.myrecipes.ui.common.recipe.modifier
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            val userCase = SaveRecipeUseCase(
                recipeRepository, stepRepository, ingredientRepository, database
            )

            userCase.execute(getFromQr().copy(imageUrl = null, name = "Gateau aux pommes")
                .let {
...
class TestImageGenerationWorker @AssistedInject constructor(
    ...
    context, params, recipeDao, ingredientDao
)